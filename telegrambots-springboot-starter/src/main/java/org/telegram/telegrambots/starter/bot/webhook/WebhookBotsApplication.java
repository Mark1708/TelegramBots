package org.telegram.telegrambots.starter.bot.webhook;
...
@Slf4j
@RestController
public class WebhookBotsApplication
        implements TelegramBotsApplication<SpringTelegramWebhookBot>, AutoCloseable {
    private final AtomicBoolean isRunning = new AtomicBoolean(false);

    private final ConcurrentHashMap<String, SpringTelegramWebhookBot> registeredBots = new ConcurrentHashMap<>();

    public WebhookBotsApplication() throws TelegramApiException {
        isRunning.set(true);
    }
